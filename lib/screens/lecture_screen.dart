        ...
        return Scaffold(
          ...
          floatingActionButton: Padding(
            ...
            child: FutureBuilder(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  List<String> myCourses = snapshot.data!.getStringList("my_courses") ?? [];

                  if (myCourses.isNotEmpty) {
                    isEnrolled = myCourses.contains(widget.channel.id);
                  }
                          ...
                          if (isEnrolled) {
                            ApiService()
                              ...
                              if (value["success"] == "MyCourse Removed Successfully" || value["message"] == "Call to a member function delete() on null") {
                                setState(() {
                                  if (myCourses.remove(widget.channel.id)) {
                                    snapshot.data!.setStringList("my_courses", myCourses);
                                  }
                                });
                            ...
                            ApiService()
                              ...
                              if (value["success"] == "Course Add Successfully To My Course" || value["error"] == "Already Add To My Course") {
                                setState(() {
                                  myCourses.add(widget.channel.id);
